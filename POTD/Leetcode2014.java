public class Leetcode2014 {
      ...
      public static boolean isSubsequence(String s, String sub, int k) {
            int i = 0, j = 0;
      ...
      public static boolean backtracking(String s, StringBuilder curr, boolean[] canUse, int[] requiredFreq, int k,
                  int maxLen) {
